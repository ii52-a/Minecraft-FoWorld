...
public class MenuRegistry {
    ...
    public static final RegistryObject<MenuType<LowerLeverCrusherMenu>> LOWER_LEVER_CRUSHER =
            MENUS.register("lower_lever_crusher",
                    () -> IForgeMenuType.create(LowerLeverCrusherMenu::new)
            );
